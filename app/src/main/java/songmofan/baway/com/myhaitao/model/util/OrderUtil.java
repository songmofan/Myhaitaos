...
public class OrderUtil {
    ...
    public static void getDataFromServer(String key, String cart_id,int ifcart, final GettextbBacks gettextbBacks) {
        ...
        //调用接口的方法 返回call集合
        Call<AddshopBean> order = getDataServes.order(key, cart_id, ifcart);
        order.enqueue(new Callback<AddshopBean>() {
            @Override
